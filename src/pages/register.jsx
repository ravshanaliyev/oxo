        ...
        <div style={{ backgroundImage: `url(${LoginImg})`, backgroundPosition: 'bottom left', backgroundRepeat: 'no-repeat' }} className='w-full h-[90vh] flex justify-center items-center '>
            <div className='w-[407px] border shadow-lg rounded-lg px-10 py-4'>
                <div className="flex justify-between">
                    ...
                    <Link to={"/register"} className='text-[20px] border-primary border-b-[4px] pb-1 w-[60%] text-center'>Ro&#39;yxatdan o&#39;tish</Link>
                </div>
                <p className='text-red mt-2'>{isError && "Email yoki parol xato"}</p>
                <form className='mt-2' onSubmit={handleSubmit(submit)}>
                    <div className="flex flex-col gap-1 mt-4 ">
                        <label className='text-sm  text-tertiary' htmlFor="image">Rasm</label>
                    ...
                    <div className="flex flex-col gap-1 mt-4 ">
                        <label className='text-sm text-tertiary' htmlFor="fullname">Ism va Familiya</label>
                    ...
                    <div className="flex flex-col gap-1 mt-4 ">
                        <label className='text-sm  text-tertiary' htmlFor="city">Joylashuv</label>
                    ...
                    <div className="flex flex-col gap-1 mt-4 ">
                        <label className='text-sm  text-tertiary' htmlFor="username">Username</label>
                    ...
                    <Button type='submit' id="login-btn" className="bg-primary rounded-xl px-4 py-3 text-white text-[16px] mt-6 w-full">Ro&#39;yxatdan o&#39;tish</Button>
                </form>
            </div>
        </div>
    )
