            ...
            <div className='w-[1111px] mx-auto'>
                ...
                <div className='rounded-xl px-6 py-5 bg-white '>
                    ...
                    <div className='mb-6 flex flex-col w-[780px]'>
                        ...
                        <input className='h-[44px] border  rounded-lg px-4 mt-1  bg-[#F6F6F6]' id='name' type="text" placeholder='Masalan iphone 13 pro max' />
                    </div>
                    <div className='mb-6 flex flex-col w-[780px]'>
                        <label className='text-gray-500 text-sm' htmlFor="rukn">Rukn</label>
                        <select className='h-[44px] border  rounded-lg px-4 mt-1  bg-[#F6F6F6]' name="rukn" id="rukn">
                ...
                <div className='rounded-xl px-6 py-5 bg-white mt-6'>
                    ...
                    <div className='mb-6 flex flex-col w-[780px]'>
                        ...
                        <input className='h-[44px] border  rounded-lg px-4 mt-1  bg-[#F6F6F6]' id='image' type="text" placeholder='Masalan https://www.heathermurphygroup.com/wp-content/uploads/2024/03/Savannah-Home-Listings-800x569.jpg' />
                    </div>
                </div>
                <div className='rounded-xl px-6 py-5 bg-white mt-6  '>
                    <div className='mb-6 flex flex-col w-[780px]'>
                        <label className='text-gray-500  text-sm' htmlFor="desc">Tavsif</label>
                        <textarea rows={8} className='border  rounded-lg px-4 mt-1  bg-[#F6F6F6] py-2' id='desc' type="text" placeholder='E&#39; lon haqida batafsil' />
                    </div>
                ...
                <div className='rounded-xl px-6 py-5 bg-white mt-6  '>
                    ...
                    <div className='mb-6 flex flex-col w-[780px]'>
                        ...
                        <input className='border  rounded-lg px-4 mt-1  bg-[#F6F6F6] py-2 h-[44px]' id='place' type="text" placeholder='Masalan Toshkent, Bektemir tumani' />
                    </div>
                    <div className='mb-6 flex flex-col w-[780px]'>
                        <label className='text-gray-500  text-sm' htmlFor="fullname">Ism</label>
                        <input className='border  rounded-lg px-4 mt-1  bg-[#F6F6F6] py-2 h-[44px]' id='fullname' type="text" placeholder='Ismingizni kiriting' />
                    </div>
                    <div className='mb-6 flex flex-col w-[780px]'>
                        <label className='text-gray-500  text-sm' htmlFor="email">Email manzil</label>
                        <input className='border  rounded-lg px-4 mt-1  bg-[#F6F6F6] py-2 h-[44px]' id='email' type="text" placeholder='Email manzilingiz' />
                    </div>
                    <div className='mb-6 flex flex-col w-[780px]'>
                        <label className='text-gray-500  text-sm' htmlFor="tel-number">Telefon raqam</label>
                        <input className='border  rounded-lg px-4 mt-1  bg-[#F6F6F6] py-2 h-[44px]' id='tel-number' type="text" placeholder='Telefon raqamingiz' />
                    </div>
                </div>
                <div className='flex justify-end mt-4'>
                    <Button className="bg-[#19191C] rounded-lg px-16 py-[12px] text-white text-[16px]">E&#39;lon joylash</Button>
                </div>
            </div>
        </div>
    )
